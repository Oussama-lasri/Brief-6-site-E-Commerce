<footer class="bg-dark text-white py-5 mt-5">
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        <h5>About Us</h5>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque at magna id tellus luctus fermentum.</p>
      </div>
      <div class="col-md-3">
        <h5>Quick Links</h5>
      ...
      <div class="col-md-3">
        <h5>Contact Us</h5>
        <p>123 Main Street<br>safi, MOROCCO</p>
        <p>Email: info@example.com<br>Phone: 555-555-5555</p>
      </div>
    </div>
    <div class="row mt-3">
      <div class="col text-center">
        <p class="text-muted">Copyright &copy; 2021 Example Company</p>
      </div>
    </div>
  </div>
</footer>
